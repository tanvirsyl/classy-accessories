...
public class ComfirmFinalOrderActivity extends AppCompatActivity {
    ...
    private void Check()
    {
        ...
        if (TextUtils.isEmpty(nameEditText.getText().toString())){
        ...
        else if(nameEditText.getText().toString().matches(".*\\d.*")){
            nameEditText.setError("what are doing man!");
        }
            ...
            Toast.makeText(this, "Please enter your city ", Toast.LENGTH_SHORT);
        }
        else if(cityEditText.getText().toString().matches(".*\\d.*")){
            cityEditText.setError("what are doing man!");
        }
                    ...
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful())
                                    {
                                        Toast.makeText(ComfirmFinalOrderActivity.this, "Your order is confirmed.",
